<head>
  ...
  <link href="assets/css/style.css" rel="stylesheet">
   <link href="assets/css/ViewContractors.css" rel="stylesheet">
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
       <ul>
          ...
          <li><a class="nav-link scrollto" href="index.jsp#contractor">Hire Contractor</a></li>
          <li><a class="nav-link scrollto" href="index.jsp#expert">Book Meeting</a></li>
          <li><a class="nav-link   scrollto" href="index.jsp#schemes">New Schemes</a></li>
          ...
          <li><a class="nav-link   scrollto" href="index.jsp">Update Profile</a></li>
