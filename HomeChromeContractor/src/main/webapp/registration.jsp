					...
					<div class="signup-form">
						...
						<form method="post" action="register" class="register-form"
							...
							<div class="form-group">
								...
								<input type="password" name="lcount" id="re_pass" required="required"
									placeholder="Labour Count" />
							</div>
							<div class="form-group">
								<label for="contact"><i class="zmdi zmdi-hourglass"></i></label>
								<input type="text" name="price" id="contact" required="required"
									placeholder="Price Rate" />
							</div>
							<div class="form-group">
								<label for="Hcount"><i class="zmdi zmdi-assignment"></i></label>
								<input type="number" name="hcount" id="contact" required="required"
