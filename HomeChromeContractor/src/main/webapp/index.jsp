...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="index.jsp">Home Chrome</a></h1>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#contractor">Update Profile</a></li>
          <li><a class="nav-link   scrollto" href="#contractor">Update Home-Status</a></li>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-6 " data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box">
              ...
              <h4 class="title"><a href="ViewProfile.jsp">Update Profile</a></h4>
              <p class="description">Update and want to change your profile. click here</p>
            </div>
          </div>
          ...
          <div class="col-lg-6 "data-aos="zoom-in" data-aos-delay="100" >
           <div class="icon-box">
              ...
              <h4 class="title"><a href="ViewHomeStatus.jsp">Update Home Status</a></h4>
              <p class="description">Change status of Home So that customer Knows where are you.</p>
            </div>
          </div>
          </div>
