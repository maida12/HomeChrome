...
<form action="CostEstimationServlet"  method="post" >
<b>
...
<tr>
<td><p>Please Select the Quality Of Things:</p></td>
<td><label class="container">Normal Quality
  <input type="radio"   value="1" name="radio2" required="required">
  <span class="checkmark"></span>
</label>
</td>
<td>
<label class="container">Premium Quality
  <input type="radio"    value="2"name="radio2"  aria-invalid="false">
  <span class="checkmark"></span>
</label>
</td>
</tr>
...
<td><h4><span style="color:darkblue">  The Approximate Cost Will Be: ${result}  Rs</span></h4></td>
</tr>
</b>
 </table>
