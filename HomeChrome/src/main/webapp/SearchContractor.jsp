...
<form action="SearchContractorServlet"  >

<table class="table"   align="center" border="50">
<tr>
<td> Enter The Price Range of Contractors:</td>
<td> <input type="text" name="price"></td>
</tr>
<tr>
<td> Enter The Ratings of Contrators:</td>
<td> <input type="text" name="Rating"></td>
</tr>

<tr>
<td><label for="type">Choose Parameters to search with:</label>
<td>
